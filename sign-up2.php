...

{
	...
	//header("location: http://www.bestnamebadges.com/");
...

{
...

	{
		...
		$_POST["ip"] = $_SERVER['REMOTE_ADDR'];
			...
			echo "<strong>Best Name Badges has received a new Sign Up:</strong>";
			...
			mail("support@bestnamebadges.com", "New Sign Up", $contents1, $email_headers);
    ...
    <div id="content">	
     ...
     <div id="mainContentFull">
	  ...
	  <h2>Name Badge Ordering</h2>
  		...
  		<h4>Please Create A New Account Or Sign-In To An Existing Account</h4>
        ...
        <h3 style="font-size: 20px;">Step 1 > Create Your Account:</h3><br />
        ...
        return false;">
        <img src='/images/love-us-seal.jpg' style="margin-top: 40px; margin-left: 10px;" /></a>
...
<div style="width:391px; height: 173px; background-image: url(images/signUp-boxbg.jpg);">
        ...
        <a href="#" onclick="window.open('https://www.sitelock.com/verify.php?site=www.bestnamebadges.com','SiteLock','width=600,height=600,left=160,top=170');" ><img alt="website security" title="SiteLock"  src="//shield.sitelock.com/shield/www.bestnamebadges.com"/></a>
