...
// only if req_fifo shows "loaded"
	...
	{	
		document.getElementById('imageshow').innerHTML="<b>Please Choose a Badge Type on the Left</b>";
	} else {
...
<form name="frameform" id="frameform" action="add-names.php" method="post" onsubmit="return checkstyle();">
	...
	<?php } while ($newstyle = mysql_fetch_assoc($newstyles)); ?>
          ...
          <div class="signUpField" style="border-top-width: 1px; border-top-style: dashed; border-top-color: #CCC;">
			...
			We accept the following formats:  <strong>(.AI, .EPS, .PSD, .PDF, .JPG, .PNG, .BMP)</strong></p>
		  </div>
          <div class="signUpField" style="border-top-width: 1px; border-top-style: dashed; border-top-color: #CCC;">
            ...
            <div class="signUpFieldRight" style="height: auto;">
                ...
                Logo 1: 
                 <div style="clear: both; margin-top: 0px; height: 75px; text-align: center;"><table height="75"><tr>
                   <td valign="middle"><?php if ($_SESSION["logo1"]) { ?><font color='green'>Image Uploaded</font><br /><a href="wizard2.php?remove=1" style="font-size: 11px;">remove image</a><?php } else { ?>(<a href="logo-upload2.php?logo=1&wizard=wizard2" style="font-size: 11px;" title="Upload Logo 1" rel="gb_page_center[400, 200]">click to upload</a>)<?php } ?></td></tr></table></div>
				  
                </div>
              <div style="float: right; width: 165px; margin-top: 0;">
                Logo 2:
                <div style="clear: both; margin-top: 0px; height: 75px; text-align: center;">
                <table height="75"><tr><td valign="middle"><?php if ($_SESSION["logo2"]) { ?><font color='green'>Image Uploaded</font><br /><a href="wizard2.php?remove=2" style="font-size: 11px;">remove image</a><?php } else { ?>(<a href="logo-upload2.php?logo=2&wizard=wizard2" style="font-size: 11px;" title="Upload Logo 2" rel="gb_page_center[400, 200]">click to upload</a>)<?php } ?></td></tr></table> </div>
                
              </div> 
            </div>
          </div>
  		  <div class="signUpField" style="border-top-width: 1px; border-top-style: dashed; border-top-color: #CCC;">
					<div class="signUpFieldLeft">Lines Of Text:</div>
			 		<div class="signUpFieldRight">
					<input type="radio" name="lines" value="1" checked/> 1&nbsp;&nbsp;<input type="radio" name="lines" value="2" /> 2&nbsp;&nbsp;<input type="radio" name="lines" value="3" /> 3
            		</div>
				</div>
          <div class="signUpField" style="border-top-width: 1px; border-top-style: dashed; border-top-color: #CCC;">
