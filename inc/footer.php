<div id="footer">
  <div id="subFooter">
      ...
      <div id="subFooterMain2">
        <div id="subFooterMain3">
          <div id="subFooterLeft">
          	<h5>Promotional Newsletter Signup</h5>
    ...
    <div id="footerCopyright">
      <div id="copyrightLeft">Copyright <?php echo date(Y) ;?> Best Name Badges. All Rights Reserved  <br/>  <g:plusone size="medium" annotation="inline" width="120"></g:plusone>&nbsp;&nbsp;<fb:like send="false" layout="button_count" width="50" show_faces="false"></fb:like></div>
      <div id="copyrightRight">Partners:<br/><a href="http://www.bnbpromotionalproducts.com">BNB Promotional Products</a></div>
    </div>
    <div style="clear: both;"></div>
<br />
...
<span id="phplive_btn_1430322885" onclick="phplive_launch_chat_1(0)" style="color: #0000FF; text-decoration: underline; cursor: pointer; position: fixed; bottom: 0px; right: 0px; z-index: 1000;"></span>
<script type="text/javascript">

(function() {
var phplive_e_1430322885 = document.createElement("script") ;
phplive_e_1430322885.type = "text/javascript" ;
phplive_e_1430322885.async = true ;
phplive_e_1430322885.src = "//www.bnblivechat.com/chat/js/phplive_v2.js.php?v=1|1430322885|0|" ;
document.getElementById("phplive_btn_1430322885").appendChild( phplive_e_1430322885 ) ;
})() ;

</script>

<script type="text/javascript">
adroll_adv_id = "5CNGE3XZB5BNJA7HLPOMTR";
adroll_pix_id = "FNM3TRFXXZEDJJ47VLRDRZ";
(function () {
