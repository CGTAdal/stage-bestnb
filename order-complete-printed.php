     ...
     <div id="mainContentFull">
	  ...
	  <h2>Digitally Printed Name Badge Ordering</h2>
					...
					<script>
						function createUploader(){            
				            ...
				            var uploader = new qq.FileUploader({
					            ...
					            onComplete: function(id, fileName, responseJSON){
							        $("#design4").html('<input type="hidden" name="design4" value="/logonews/'+responseJSON.filename+'" />');
				                	$("#check_submit").val('1')	 
								} 
				            });   
				            var uploader = new qq.FileUploader({
        ...
        <div class="signUpField">
         ...
         <form method="post" id="wizard-next" name="wizard-next" action="wizard-next.php">
         	 <input type="hidden" value="0" name="check_submit" id="check_submit">
         	 <input type="hidden" value="1" name="num_design" id="num_design" />
         	 <input type="hidden" vale="0" name="check_choose_file" id="check_choose_file" />
	         ...
	         <input type="hidden" name="type" value="Digitally Printed Pro Badges">	           
		 ...
		 <div class="boxHeader"><span style="float: left;">Additional Options</span></div>
          ...
          <div class="signUpField">
            ...
            <div class="signUpFieldRight"><input type="text" name="quantity" value="" style="width: 50px;" class="signupFieldInput" /> quantity</div>
          </div>
