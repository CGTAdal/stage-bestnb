  ...
  <div id="subFooter">
    ...
    <ul id="footerMenu">
      ...
      <li><a href="/sign-up.php">Buy Now</a></li>
      <li class="footerMenuSpacer">|</li>
      ...
      <li class="footerMenuSpacer">|</li>
	  <li><a href="/client-templates.php">Templates</a></li>
      <li class="footerMenuSpacer">|</li>
      <li><a href="/contact-us.php">Contact Us</a></li>
    </ul>
    <div id="footerCopyright">
      <div id="copyrightLeft">Copyright <?php echo date(Y) ;?> Best Name Badges. All Rights Reserved</div>
      <div id="copyrightRight">Partners: <a href="http://www.anticoelements.com">Faux Stone Panels</a>
      <br/><a href="http://www.elettropromos.com">Promotional Products</a></div>
    </div>
    <div style="clear: both;"></div>
<br />
<br />
