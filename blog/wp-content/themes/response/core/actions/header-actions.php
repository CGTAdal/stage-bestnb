...
function response_nav() {
  ...
  <div id="header">
    ...
    <div id="headerBar">
      ...
      <div id="navigationWrapper">
        <div id="navigationTop">
        	<ul>
            	<li><a href="https://www.bestnamebadges.com">Home</a></li>
    ...
    <a href="/name-badges.php"><img src="/images/best-name-badge-blog-header.jpg" width="960" height="148" alt="The Best Name Badge Blog - Relevant and Not So Relevant Writings"></a>
    </div>
 <?php
}
