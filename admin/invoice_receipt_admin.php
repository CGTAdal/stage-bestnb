  ...
  <tr>
    <td height="32" colspan="2"><table width="700" border="0" cellspacing="2" cellpadding="5">
	 ...
	 <?php 
        ...
        $qry = "SELECT invoice_id FROM orders WHERE id = ".$order["oid"];
        $invoice_id = mysql_query($qry);
        $invoice_id = mysql_fetch_assoc($invoice_id);        
        ...
        if($result_total){                                
            while($row_total = mysql_fetch_assoc($result_total)){
                ...
                $item[] = $row_total;
                $total_invoice = $total_invoice  + $row_total['total'];
     ...
     ?>           
      <tr>
          ...
          <td align="center" valign="middle"><?php echo formatMoney($it['total']);?></td>
      </tr>      
      <?php } ?>    
      ...
      <tr>
        ...
        <td align="center" valign="middle"><strong>$<?php echo number_format(round($total_no_discount,2),2,'.',','); ?></strong></td>
      </tr>
      
      <tr>
        <td colspan="2" align="center" valign="middle">&nbsp;</td>
        <td align="center" valign="middle" style="font-size: 11px;">TOTAL CHARGED</td>
        <td align="center" valign="middle"><strong>$<?php echo $total_invoice;?></strong></td>
      </tr>
    </table></td>
  </tr>
  <tr>
