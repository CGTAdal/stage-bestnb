  ...
  <tr>
    <td height="32" colspan="2"><table width="700" border="0" cellspacing="2" cellpadding="5">
      ...
      <tr>
        ...
        <td align="center" valign="middle"><?php echo formatMoney($badgestotal + $framestotal + $domestotal); ?></td>
      </tr>
	  <tr>
        <td colspan="2" align="center" valign="middle">&nbsp;</td>
      ...
      <tr>
        ...
        <td align="center" valign="middle"><strong><?php echo formatMoney($badgestotal + $framestotal + $domestotal + $order["setup"] + $order["tax"]); ?></strong></td>
      </tr>
    </table></td>
  </tr>
  <tr>
