...
$pagetitle = "Magnetic Name Badges Work Better - Best Name Badges";
$metadescription = "Use magnetic name badges to impress your customers.  Magnetic fasteners keep badges in place without damaging clothing.";
...
if ($_SESSION["customerloginid"])
{
  ...
  <div id="content">
    ...
    <div id="mainContent" class="magnetice-content">
    	<h2>Our Magnetic Name Tag Products</h2>
    ...
    <div style="clear: both;"></div><br />
				  <h2>Magnetic Name Badges</h2>
			      <h4>Keeping Your Clothes Safe From Pins</h4>
				  <p>Are you having doubts over the effectiveness of name tags? Do you feel that they may be of little or no use to your business? Well you'd  be surprised by what this article has to say then.
			</p>
			<h4>The Finest Badges Are Magnetic</h4>
			<p>
			Surveys have actually proven that employees who wear name tags do so with great pride. Furthermore, they actually feel a sense of attachment to the company they work for. The reason for this is simple. They don't feel like just another employee. They feel like a valued service provider. On the whole, it's great (and extremely easy) way to bring out a higher level of productivity. And of course, these badges give your company a professional look.
			</p>
			<h4>They Look Better, And Last Longer</h4>
			<p>
			Magnetic name badges, among all others, are probably the most stylish types out there. As the name suggests, the badge has a magnet on the underside. It stays on a shirt by attracting the metal piece, which you'll put on the underside of your shirt. There are no messy pins for you to deal with. The classy look also makes it perfect for senior executives. And to top it all of, these badges last much longer too. 
			</p><p>
			On the whole, investing in magnetic name badges would be a wise choice. I'm sure you'd be amazed when you observe that having them actually boosts your business.
			      </p>
